System.register("class-transformer/Include", [], function (exports_1, context_1) {
    var Include;
    ...
    return {
        ...
        execute: function () {
            (function (Include) {
                 ...
                 */
                Include["NON_NULL"] = "NON_NULL";
            })(Include || (Include = {}));
            exports_1("Include", Include);
        }
    };
});
System.register("class-transformer/ClassTransformOptions", [], function (exports_2, context_2) {
...
System.register("class-transformer/metadata/ExposeExcludeOptions", [], function (exports_3, context_3) {
...
System.register("class-transformer/metadata/TypeMetadata", [], function (exports_4, context_4) {
    var TypeMetadata;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_4("TypeMetadata", TypeMetadata);
        }
    };
});
System.register("class-transformer/metadata/ExposeMetadata", [], function (exports_5, context_5) {
    var ExposeMetadata;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_5("ExposeMetadata", ExposeMetadata);
        }
    };
});
System.register("class-transformer/metadata/ExcludeMetadata", [], function (exports_6, context_6) {
    var ExcludeMetadata;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_6("ExcludeMetadata", ExcludeMetadata);
        }
    };
});
...
System.register("class-transformer/metadata/MetadataStorage", ["class-transformer/TransformOperationExecutor"], function (exports_8, context_8) {
...
System.register("class-transformer/TransformOperationExecutor", ["class-transformer/storage", "class-transformer/Include"], function (exports_10, context_10) {
    var storage_1, Include_1, TransformationType, TransformOperationExecutor;
    ...
    exports_10("testForBuffer", testForBuffer);
    return {
        setters: [
        ...
        execute: function () {
            ...
            exports_10("TransformationType", TransformationType);
            TransformOperationExecutor = /** @class */ (function () {
                ...
                TransformOperationExecutor.prototype.getKeys = function (target, object) {
                    ...
                    keys = this.applyIncludePolicy(keys, object, this.options.includePolicy || Include_1.Include.DEFAULT);
                    return keys;
                };
                ...
                TransformOperationExecutor.prototype.applyIncludePolicy = function (keys, object, include) {
                    if (include === Include_1.Include.DEFAULT) {
                        return keys;
                    }
                    else if (include === Include_1.Include.NON_NULL) {
                        return keys.filter(function (it) { return object[it] !== null; });
                    }
                    else {
...
System.register("class-transformer/ClassTransformer", ["class-transformer/TransformOperationExecutor"], function (exports_11, context_11) {
...
System.register("class-transformer/decorators", ["class-transformer/ClassTransformer", "class-transformer/storage", "class-transformer/metadata/TypeMetadata", "class-transformer/metadata/ExposeMetadata", "class-transformer/metadata/ExcludeMetadata", "class-transformer/metadata/TransformMetadata"], function (exports_12, context_12) {
    ...
    exports_12("TransformPlainToClass", TransformPlainToClass);
    return {
        setters: [
...
System.register("class-transformer/index", ["class-transformer/ClassTransformer", "class-transformer/decorators"], function (exports_13, context_13) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_13("TransformationType", TransformationType);
        }
    };
});
